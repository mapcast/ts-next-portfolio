    ...
    <>
      <nav>
        ...
        <ul>
            ...
            <li>
                <Link href="/projects/#fs" legacyBehavior>
                    <a className={bhs.className}>파일 공유 시스템</a>
                </Link>
            </li>
            <li>
                <Link href="/projects/#cucumber" legacyBehavior>
                    <a className={bhs.className}>Cucumber</a>
                </Link>
            </li>
            <li>
